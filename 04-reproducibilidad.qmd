...
```{r}
#| label: fig-espectro-reproducibilidad
#| fig.cap: Espectro de reproducibilidad. Imagen de [Anita Graser](https://www.youtube.com/watch?v=ZjXb53pOor0), basada en [(Peng, 2001)](https://doi.org/10.1126/science.1213847). 
#| echo: false

knitr::include_graphics(rep("img/espectro-reproducibilidad.png"))
```
