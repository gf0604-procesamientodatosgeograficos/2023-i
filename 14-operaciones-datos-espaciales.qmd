...
Este archivo proviene de un [geoservicio de tipo Web Feature Service (WFS)](http://geos.snitcr.go.cr/be/IGN_5/wfs) publicado por el Instituto Geográfico Nacional (IGN). Se utiliza una versión del año 2020 (con 82 cantones). Las geometrías se simplificaron con el método [st_simplify()](https://r-spatial.github.io/sf/reference/geos_unary.html), para reducir el tamaño del archivo.
...
[Archivo GeoJSON de cantones de Costa Rica (del año 2020) con geometrías simplificadas](https://github.com/gf0604-procesamientodatosgeograficos/2023-i/blob/main/datos/ign/delimitacion-territorial-administrativa/cantones_2020_simp_10m.geojson)
...
Este archivo, con registros de presencia de especies silvestres de la familia [*Felidae*](https://es.wikipedia.org/wiki/Felidae) en Costa Rica, proviene de una [consulta al portal de datos de la Infraestructura Mundial de Información en Biodiversidad (GBIF)](https://doi.org/10.15468/dl.nq74xg).

[Archivo CSV de registros de presencia de félidos silvestres de Costa Rica)](https://github.com/gf0604-procesamientodatosgeograficos/2023-i/blob/main/datos/gbif/felidos.csv)
...
Mapas de félidos dentro de Sarapiquí y a 10 km de Sarapiquí
:::

#### Unión de datos espaciales
La unión “no espacial” de dos conjuntos de datos se basa en una o varias columnas (llamadas llaves o *keys*) que están presentes en ambos conjuntos. Las uniones espaciales se basan en un principio similar pero, en lugar de columnas, la relación entre los conjuntos se realiza a través de un predicado espacial. 
