...
## Recursos de interés
Carrera Arias, F. J. (2020). *How to Install R on Windows, Mac OS X, and Ubuntu Tutorial*. DataCamp Community. [https://www.datacamp.com/community/tutorials/installing-R-windows-mac-ubuntu](https://www.datacamp.com/community/tutorials/installing-R-windows-mac-ubuntu)
...
*Quarto—Markdown Basics*. (s. f.). Recuperado 25 de marzo de 2023, de [https://quarto.org/docs/authoring/markdown-basics.html](https://quarto.org/docs/authoring/markdown-basics.html)
