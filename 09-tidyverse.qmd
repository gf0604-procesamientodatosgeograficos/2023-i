...
knitr::include_graphics(rep("img/data-science-explore.svg"))
```
...
- [dplyr](https://dplyr.tidyverse.org/): gramática que proporciona un conjunto consistente de "verbos" que resulven los retos más comunes de transformación de datos.
...
knitr::include_graphics(rep("img/datos-tidy.svg"))
```
