...
7. Aplique los filtros anteriores desde la interfaz de QGIS.
...
1. Descargue en su directorio de trabajo la capa de altitud desde la dirección [https://biogeo.ucdavis.edu/data/worldclim/v2.1/base/wc2.1_30s_elev.zip](https://biogeo.ucdavis.edu/data/worldclim/v2.1/base/wc2.1_30s_elev.zip).
...
1. Recorte la capa raster de altitud global con el contorno de la capa de cantones de Costa Rica:

```shell
# Recorte de la capa raster de altitud global con el contorno de la capa de cantones de Costa Rica
gdalwarp -dstnodata -9999 -tr 0.00833333 0.00833333 -q -cutline 'cantones-wgs84.gpkg' -crop_to_cutline wc2.1_30s_elev.tif altitud-cr.tif
